...
public class FoldingPlainView extends PlainView {
     ...
     * @param direction the direction from the current position that can be thought of
     ...
     * @throws IllegalArgumentException if <code>direction</code> doesn't have one of the legal
     *                                  values above
     */
     ...
     * @throws BadLocationException if the given position does not represent a valid location
